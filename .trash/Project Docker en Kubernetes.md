...
Dan volgen we de volgende stappen om deze toe te voegen op ons systeem.
```shell
git init
git add .
...
#### 7.2.3 Eerste instellingen en env variables
...
#### 7.2.4 Build en push docker image
